    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="./update-new.php" method="post"
                ...
                <div class="form-group">
                    <label for="exampleFormControlCategory1">Категорія</label>
                    <input name="category" required type="text" class="form-control" id="exampleFormControlCategory1" value="<?=$post['category']?>">
                </div>
